...
The stellar spectra used to construct the templates are completely selected from  LAMOST Data Release One (DR1) and they  are gathered in 252 different groups by:
...
Its design enables it to take 4000 spectra in a single exposure to a limiting magnitude as faint as r=19 at the resolution R=1800, which is equivalent to the design goal of r=20 for the resolution R=500.
...
LAMOST data are processed by data pipelines written specifically for the LAMOST Spectral Survey.
