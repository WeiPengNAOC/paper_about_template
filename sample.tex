...
Due to the existence of wavelength points with $flux\le0$, a large amount of  spectra are excluded and 325 spectra are selected from the first 5,000 spectra with the highest SNR.
...
To check the quality, we choose the M2-type template spectrum in the current template library \citep{wang2010calibration} and compare it with the template spectrum of group 222 (see Fig \ref{Fig94} upper panel).
...
We choose the M2-type template spectrum and alsoe compare it with the template spectrum of group 222 (see Fig \ref{Fig94} bottom panel).
...
Meanwhile, some unlabeled or wrongly labeled spectra are relabeled  or abandoned.
Finally, the new stellat classification templates library LAMOST spectra analysis pipeline consists of 164 spectra and 65 different MK classes.
